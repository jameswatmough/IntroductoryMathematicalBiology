...
![Phase Portrait](figures/figure-nullclines){#fig-nullclines width=80%}
...
![Nullclines for the Rosenzweig-MacArthur model](figures/figure-nullcline-2){#fig-nullcline-2}
...
@holling1959 introduced a simple classification of functional responses of predators into type I, II, or III (see @fig-hollingIII).  Mathematically, type I and II are similar,  and represent a saturating response.


```{r engine='tikz'}
#| label: fig-hollingIII
#| echo: false
...
```{r engine='tikz'}
#| label: fig-trace-determinant-diagram
#| fig-cap: Stability of equilibria based on the trace and determinant of the Jacobian matrix
#| echo: false
