...
2. if an individual is alive at time $t$, the probability of that individual tying before time $t+\tau$ is proportional to the waiting time $\tau$ and independent of $t$.
